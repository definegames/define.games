    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 py-4">
        <div className="max-w-5xl mx-auto px-6 flex items-center gap-8">
          <div className="text-2xl font-normal text-gray-700 flex-shrink-0" style={{ marginTop: -5 }}>
      ...
      <main className="py-6">
        <div className="max-w-5xl mx-auto px-6 flex gap-8">
          {/* Logo spacer to match header alignment */}
          <div className="flex-shrink-0 text-2xl font-normal invisible">
